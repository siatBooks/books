...
public class ViewMain {
            ...
            try {
                ...
                switch (num) {
                    ...
                    case 3:
                        ...
                        // System.out.println("주문 리스트");
                        // System.out.println("주문 리스트");
                        orderHistory(scanner, false); // 최초 진입이므로 false
                        break;
                    case 4:
                        cart(scanner); 
                        break;
    ...
    //오더히스토리 처음생성      
    private static void orderHistory(Scanner scanner, boolean isFromBack) { /* 처음 들어올 때만 안내 메시지 출력 */
        while (true) {
            try {
                if(!isFromBack){  
                    System.out.println("==================[주문 이력 확인 페이지]==================");
                    System.out.println("이곳에서 고객님의 모든 주문 이력을 확인 할 수 있습니다.");
                }
                // System.out.println("> 주문 id : ");
                // System.out.println("> 주문일자 :");
                // System.out.println("> 주문주소 : ");
                // System.out.println("> 총 주문금액 : ");
                System.out.println(" ");
                System.out.println("원하시는 번호를 선택하세요 : ");
                System.out.println("= 1. 최근 주문 내역 보기");
                System.out.println("= 2. 특정기간 주문 내역 검색");
                System.out.println("= 3. 뒤로가기 ");
                System.out.println("= 0. 홈페이지 돌아가기 ");
                System.out.println("= 99. 종료     ");
                System.out.println("* 숫자 8을 입력하면 모든 화면에서 장바구니 보기 화면으로 넘어갑니다");
                System.out.println(" ");
                System.out.print("선택: ");
    ...
    private static void resent_order(Scanner scanner) {
        while (true) {
            try {
                System.out.println("==================[최근 주문 내역 보기]==================");
                // Displaying test data for recent orders
                System.out.println("주문 ID: 12345");
                System.out.println("주문 일시: 2025-04-01 14:30");
                System.out.println("책 이름: Java Programming");
                System.out.println("상태: 배송 완료");
                System.out.println("수량: 1");
                System.out.println("주문 총 금액: 30,000원");
                
                System.out.println("\n");
                System.out.println("주문 ID: 67890");
                System.out.println("주문 일시: 2025-03-28 10:15");
                System.out.println("책 이름: Python Basics");
                System.out.println("상태: 배송 중");
                System.out.println("수량: 2");
                System.out.println("주문 총 금액: 50,000원");
                ...
                int num = scanner.nextInt();
                    ...
                    switch (num) {
                        case 1:
                            orderHistory(scanner,true); // 뒤로가기니까 true
                            break; 
                        case 0:
                            home(scanner);
                            break;
    ...
    private static void date_order(Scanner scanner) {
        while (true) {
            try {
                System.out.println("==================[특정 기간 주문 내역 검색]==================");
        
                // Prompt user to input date range
                System.out.print("검색할 시작 날짜를 입력하세요 (YYYY-MM-DD): ");
                String startDate = scanner.nextLine();
                
                System.out.print("검색할 종료 날짜를 입력하세요 (YYYY-MM-DD): ");
                String endDate = scanner.nextLine();
        
                // Displaying test data for orders in the given date range
                System.out.println("\n" + startDate + "부터 " + endDate + "까지의 주문 내역:");
                
                // Example data
                if (startDate.equals("2025-03-01") && endDate.equals("2025-03-31")) {
                    System.out.println("주문 ID: 54321 | 주문 일시: 2025-03-15 09:00 | 책 이름: C++ Guide | 상태: 배송 완료 | 수량: 1 | 총 금액: 25,000원");
                    System.out.println("주문 ID: 98765 | 주문 일시: 2025-03-20 16:45 | 책 이름: Data Structures | 상태: 배송 중 | 수량: 3 | 총 금액: 75,000원");
                } else {
    ...
    private static void user(Scanner scanner) {
        while (true) {
            try {
                ...
                System.out.println("= 0. 홈페이지 돌아가기 ");
                System.out.println("= 99. 종료     ");
                // System.out.println("1 회원 정보 수정  2 뒤로가기 0 홈페이지 돌아가기 99 종료");
                System.out.println("* 숫자 8을 입력하면 모든 화면에서 장바구니 보기 화면으로 넘어갑니다");
                System.out.println("\n");
                System.out.print("선택: ");
                int num = scanner.nextInt();
    ...
    //회원 정보 수정 (새로 입력)
    private static void update_user(Scanner scanner) {
        while (true) {
            try {
                System.out.println("\n\n");
                System.out.println("==================[회원 수정 조회 페이지]==================");
                ...
                switch (num) {
                    case 1:
                        ...
                        break; 
                    case 2:
                        update_phone(scanner);
                        break; 
                    case 3:
                        update_address(scanner);
                        break;
                    case 4:
                        return;
                    case 99:
    ...
    //이름 수정 (새로 입력)
    private static void update_name(Scanner scanner) {
        System.out.println(" 새 이름을 입력하세요. ");
        String newName = scanner.nextLine();
        System.out.println("이름이 '" + newName + "'(으)로 수정되었습니다.");
        // System.out.println("또 수정하실 부분이 있나요?");
        // String str = scanner.nextLine();
    ...
    //전화번호 수정 (새로 입력)
    private static void update_phone(Scanner scanner) {
        System.out.println(" 새 전화번호를 입력하세요. ");
        String newPhone = scanner.nextLine();
        System.out.println("전화번호가 '" + newPhone + "'(으)로 수정되었습니다.");
        // while (true) {
            // try {
            //     System.out.println("\n\n");
            //     System.out.println("==================[회원 수정 조회 페이지]==================");
    ...
    //주소 수정 (새로 입력)
    private static void update_address(Scanner scanner) {
        System.out.println(" 새 주소를 입력하세요. ");
        String newAddress = scanner.nextLine();
        System.out.println("주소가 '" + newAddress + "'(으)로 수정되었습니다.");
        // while (true) {
        //     try {
        //         System.out.println("\n\n");
        //         System.out.println("==================[회원 수정 조회 페이지]==================");
